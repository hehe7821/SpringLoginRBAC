...
| --- | --- | --- |
| `user_id` | `uuid` | PK, DB default `uuidv7()` |
...
| Column | Type | Description |
| --- | --- | --- |
| `role_id` | `uuid` | PK, DB default `uuidv7()` |
...
| Column | Type | Description |
| --- | --- | --- |
| `permission_id` | `uuid` | PK, DB default `uuidv7()` |
...
| `role_id` | `uuid` | FK to `roles.role_id` |
| `assigned_at` | `timestamptz` | Assigned timestamp |
| `assigned_by` | `uuid` | FK to assigning user |
...
| --- | --- | --- |
| `role_id` | `uuid` | FK to `roles.role_id` |
| `permission_id` | `uuid` | FK to `permissions.permission_id` |
| `granted_at` | `timestamptz` | Granted timestamp |
| `granted_by` | `uuid` | FK to granting user |
...
- `user_id` is generated by PostgreSQL using `uuidv7()`. The backend does not generate user IDs.
